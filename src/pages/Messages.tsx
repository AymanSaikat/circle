...
export const Messages: React.FC = () => {
 ...
 {/* ==================== 1. CONTACT SIDEBAR ==================== */}
 <div className={`w-full md:w-85 flex flex-col bg-slate-50/40 dark:bg-zinc-950/40 ${activeRecipient ? 'hidden md:flex' : 'flex'}`}>
 
 {/* Header area with custom ambient workspace look */}
 <div className="p-5 flex flex-col gap-4 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-md">
 ...
 <div className="p-4 bg-white/40 dark:bg-zinc-900/30 flex items-center gap-3 overflow-x-auto scrollbar-none shrink-0 select-none">
 ...
 : 'hover:bg-white dark:hover:bg-zinc-800 bg-transparent text-zinc-700 hover:text-zinc-950 dark:text-zinc-300 dark:hover:text-zinc-50 border border-transparent hover:border-zinc-100 dark:hover:border-zinc-800 shadow-none hover:shadow-xs'
 }`}
 >
 ...
 <span className={`text-[8px] font-bold tracking-wider uppercase px-1.5 py-0.5 rounded-md ${isSelected ? 'bg-white/10 text-white' : 'bg-zinc-100 dark:bg-zinc-800 text-zinc-500'}`}>
 Verified
 </span>
 </div>
 ...
 <div className="p-4 bg-white/90 dark:bg-zinc-900/90 text-[10px] text-zinc-400 flex items-center justify-between">
 <span className="flex items-center gap-1.5 font-semibold">
 <ShieldCheck className="w-3.5 h-3.5 text-emerald-500" />
 <span>Circle Secure System</span>
 </span>
 <span className="font-mono text-[9px] text-zinc-400 bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded">v2.1</span>
 </div>
 </div>
 ...
 <div className="p-4 bg-white dark:bg-zinc-900/90 backdrop-blur-md flex items-center justify-between sticky top-0 z-10">
 ...
 className="p-2.5 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 bg-zinc-100/60 hover:bg-zinc-200/50 dark:bg-zinc-800 dark:hover:bg-zinc-800 rounded-xl transition-all"
 >
 ...
 className={`p-2.5 rounded-xl transition-all ${showDetailPanel ? 'text-white bg-zinc-900 dark:text-zinc-900 dark:bg-white' : 'text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-50 bg-zinc-100/60 dark:bg-zinc-800 hover:bg-zinc-300/50'}`}
 >
 ...
 className="md:hidden flex items-center gap-1 text-xs font-bold text-zinc-500 dark:text-zinc-300 bg-zinc-100 dark:bg-zinc-800 px-3 py-2 rounded-xl"
 >
 ...
 <div className="bg-white/80 dark:bg-zinc-900/90 backdrop-blur-md text-[10px] font-bold text-zinc-500 dark:text-zinc-400 py-1.5 px-3.5 rounded-full border border-zinc-200 dark:border-zinc-800 inline-flex items-center gap-1.5 shadow-sm">
 ...
 : 'bg-white dark:bg-zinc-800 text-zinc-800 dark:text-zinc-100 border border-zinc-200/70 dark:border-zinc-800/80 rounded-bl-none font-medium'
 }`}
 >
 ...
 key={idx} 
 style={{ height: `${h * 3}px` }} 
 className={`w-[2.5px] rounded-full ${isOwn ? 'bg-white/60' : 'bg-zinc-400 dark:bg-zinc-600'}`} 
 />
 ))}
 </div>
 ...
 <div className="bg-zinc-50 dark:bg-zinc-900 p-2 px-3 rounded-lg border border-zinc-200 dark:border-zinc-800 flex items-center gap-2 text-[10px] text-zinc-700 dark:text-zinc-300 font-bold tracking-tight">
 ...
 <div className="absolute -bottom-2 right-2 flex items-center gap-0.5 bg-white dark:bg-zinc-800 py-0.5 px-2 rounded-full border border-zinc-100 dark:border-zinc-700 shadow-sm z-10 select-none">
 ...
 <div className="absolute bottom-full mb-1 left-0 flex items-center gap-1.5 p-1 px-1.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-xl z-30 animate-fade-in text-base">
 {['❤️', '👍', '😂', '🔥', '😮', '😢'].map((em) => (
 <button
 key={em}
 ...
 />
 <div className="bg-white dark:bg-zinc-800 py-3 px-4 rounded-2xl rounded-bl-none border border-zinc-100 dark:border-zinc-800 flex items-center justify-center gap-1 shadow-xs">
 ...
 <div className="relative bg-white dark:bg-zinc-900/90 backdrop-blur-md">
 ...
 <button onClick={() => setShowAttachmentsMenu(false)} className="text-zinc-400 hover:text-zinc-600 text-xs">✕</button>
 </div>

 <div className="grid grid-cols-2 gap-2 mb-3">
 <button
 onClick={() => handleAttachItem('voice')}
 className="flex items-center gap-2.5 px-3 py-2 text-xs font-semibold bg-zinc-100/60 dark:bg-zinc-800 hover:bg-zinc-300/50 rounded-xl text-left transition-all"
 >
 ...
 className="relative aspect-square rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-800 hover:scale-105 transition-all"
 >
 ...
 <form onSubmit={handleCustomImageSubmit} className="space-y-1.5 pt-2.5">
 ...
 <div className="w-16 h-16 rounded-2xl bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 flex items-center justify-center shadow-2xl">
 ...
 <div className="absolute md:relative inset-y-0 right-0 w-80 bg-white dark:bg-zinc-900 z-20 flex flex-col shadow-2xl md:shadow-none animate-fade-in">
 ...
 <div className="p-6 flex flex-col items-center justify-center text-center bg-slate-50/20 dark:bg-zinc-900/40">
 <img 
 src={activeRecipient.avatarUrl} 
 alt={activeRecipient.displayName}
 ...
 {activeRecipient.bio && (
 <div className="text-xs text-zinc-500 dark:text-zinc-400 mt-4 pt-4 border-dashed leading-relaxed max-w-[220px] italic">
 "{activeRecipient.bio}"
 </div>
 )}
 </div>
 ...
 <div className="flex items-center justify-between text-xs p-2.5 rounded-xl bg-slate-50 dark:bg-zinc-950 border border-zinc-100/50 dark:border-zinc-800 text-zinc-600 dark:text-zinc-400">
 ...
 key={idx} 
 onClick={() => handleAttachItem('photo', p.url)}
 className="relative rounded-lg overflow-hidden border border-zinc-200 dark:border-zinc-800 cursor-pointer hover:opacity-85 transition-all"
 ...
 <div className="p-4 bg-slate-50 dark:bg-zinc-950 text-[9px] text-zinc-400 leading-relaxed font-semibold">
