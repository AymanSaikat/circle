...
export const Profile: React.FC<ProfileProps> = ({ onTagClick, targetUserId }) => {
 ...
 <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-12 rounded-2xl max-w-sm shadow-xs">
 ...
 <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 md:p-8 shadow-xs mb-6 relative overflow-hidden">
 ...
 <Sparkles className="w-5 h-5 text-zinc-900 dark:text-zinc-100" /> Modify Public Profile
 </h3>
 ...
 className="flex items-center gap-1.5 px-4 py-2 text-xs font-bold bg-zinc-50 dark:bg-zinc-800 hover:bg-zinc-100 dark:hover:bg-zinc-700 border border-zinc-200 dark:border-zinc-700 text-zinc-700 dark:text-zinc-300 rounded-xl transition-all select-none cursor-pointer"
 >
 ...
 <p className="text-zinc-600 dark:text-zinc-300 text-sm mt-3 max-w-xl leading-relaxed whitespace-pre-wrap select-text">
 ...
 <div className="flex items-center flex-wrap gap-6 justify-center md:justify-start pt-4 mt-2">
 ...
 <div className="flex items-center gap-2 text-sm">
 <span className="font-bold text-zinc-900 dark:text-zinc-100 font-sans text-lg">{followingCount}</span>
