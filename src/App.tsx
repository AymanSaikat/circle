...
function DynamicProfileLoader({ 
 ...
 className="bg-zinc-900 dark:bg-zinc-100 hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-zinc-950 font-bold text-xs py-3 px-6 rounded-xl shadow-[0_4px_12px_rgba(0,0,0,0.1)] transition-all cursor-pointer hover:shadow-md active:scale-95"
 >
 Back to Home
 </button>
 <button
 ...
 : "bg-white dark:bg-zinc-900 border-zinc-300 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800"
 }`}
 >
...
function AppContent() {
 ...
 <div className="hidden md:flex w-64 flex-col bg-white dark:bg-zinc-950 h-screen p-6 shrink-0 justify-between">
 ...
 <div className="md:hidden flex items-center justify-between bg-white dark:bg-zinc-950 px-4 py-3">
 ...
 <div className="md:hidden flex items-center justify-around bg-white dark:bg-zinc-950 px-2 py-1.5 pb-safe-bottom absolute bottom-0 w-full shadow-[0_-10px_40px_rgba(0,0,0,0.05)] dark:shadow-none">
 {[1, 2, 3, 4, 5].map((i) => (
 ...
 const isMessages = path.startsWith('/messages') || path === '/messages' || path.startsWith('/inbox') || path === '/inbox';
 ...
 className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-bold text-xs py-2.5 px-4 rounded-xl transition-colors cursor-pointer"
 >
 Essential Only
 </button>
 </div>
 ...
 className="text-[10px] text-center text-zinc-400 dark:text-zinc-500 hover:text-zinc-900 dark:hover:text-zinc-400 transition-colors mt-0.5 underline cursor-pointer font-semibold"
 >
 Manage Settings
 </p>
 </>
 ...
 <div className="flex flex-col gap-2.5 bg-zinc-50 dark:bg-zinc-950/50 p-2.5 rounded-xl border border-zinc-200 dark:border-zinc-800/80">
 ...
 className="bg-white dark:bg-zinc-900 border border-zinc-300 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 font-bold text-xs py-2 px-4 rounded-xl transition-colors cursor-pointer"
 >
 Back
 </button>
 </div>
