...
export const CircleComposer: React.FC<CircleComposerProps> = ({ onSuccess }) => {
 ...
 return (
 <em key={pIdx} className="italic text-zinc-700 dark:text-zinc-400">
 {part.slice(1, -1)}
 </em>
 );
 }
 ...
 if (isBlockQuote) {
 return (
 <blockquote key={idx} className="pl-4 py-2 my-2 italic text-zinc-500 dark:text-zinc-400 bg-zinc-50 dark:bg-zinc-950/40 rounded-xl inline-block shadow-inner">
 {renderedElements}
 </blockquote>
 );
 }
 ...
 <div className="flex items-center justify-between gap-4 pb-4 mb-4 flex-wrap">
 ...
 <span className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 font-mono leading-none">
 @{profile?.username}
 </span>
 ...
 <div className="flex items-center gap-1.5 bg-zinc-100 dark:bg-zinc-950 p-1 rounded-xl border border-zinc-200/40 dark:border-zinc-800/40 ml-auto select-none">
 <button
 type="button"
 ...
 className={`w-full min-h-[140px] bg-zinc-50 dark:bg-zinc-950 text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 rounded-2xl p-5 border transition-all text-xs focus:outline-none resize-y pointer-events-auto leading-relaxed shadow-xs ${
 isDragActive 
 ...
 <span className="text-[9px] font-bold text-zinc-400 dark:text-zinc-500 font-mono tracking-tight select-none">
 {lastSaved}
 </span>
 </div>
 </div>
 ...
 className="p-1 rounded-lg text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-200 dark:hover:bg-zinc-800 transition-all cursor-pointer"
 title="Remove Poll"
 >
 ...
 className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-2 text-xs text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-zinc-500 font-sans"
 />
 ...
 className="flex-1 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-3 py-1.5 text-xs text-zinc-900 dark:text-zinc-100 placeholder-zinc-400 dark:placeholder-zinc-500 focus:outline-none focus:border-zinc-500 font-sans"
 />
 ...
 className="p-1.5 text-zinc-400 hover:text-red-600 dark:hover:text-red-400 rounded-lg transition-all hover:bg-red-50 dark:hover:bg-red-955/20 cursor-pointer"
 title="Delete option"
 >
 ...
 <div className="flex items-center justify-between pt-2.5 mt-1 text-[10px] text-zinc-400 dark:text-zinc-500 font-mono">
 ...
 {/* Popover Header */}
 <div className="p-3 bg-zinc-50/60 dark:bg-zinc-950/40 select-none flex flex-col gap-2">
 <div className="flex items-center justify-between">
 ...
 className="w-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl px-2.5 py-1.5 text-[11px] placeholder-zinc-400 dark:placeholder-zinc-500 text-zinc-900 dark:text-zinc-100 focus:outline-none focus:border-zinc-500 transition-all font-sans"
 autoFocus
 />
 </div>
 ...
 {!emojiSearchQuery && (
 <div className="flex items-center gap-1 overflow-x-auto px-2 py-1.5 bg-zinc-100/50 dark:bg-zinc-900/40 scrollbar-none select-none shrink-0">
 ...
 if (matched.length === 0) {
 return <p className="text-[10px] text-zinc-400 dark:text-zinc-500 text-center py-6 italic font-sans">No matching emojis found</p>;
 }

 return (
 <div>
 <div className="text-[9px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wide mb-2 select-none">Search results ({matched.length})</div>
 ...
 <div className="flex items-center gap-1 text-[9px] uppercase tracking-wider font-mono font-bold text-zinc-400 dark:text-zinc-500 mb-3 select-none">
 ...
 {mediaUrls.length > 0 && (
 <div className="flex gap-2 overflow-x-auto pb-1 mt-4 pt-3">
 {mediaUrls.map((x, idx) => (
 ...
 {error && (
 <div className="bg-red-50 dark:bg-red-950/20 border border-red-100 dark:border-red-900/40 text-red-600 dark:text-red-400 text-[11px] p-3 rounded-xl flex items-center gap-2 font-bold animate-fade-in my-0.5">
 ...
 <div className="flex flex-wrap items-center justify-between gap-4 pt-5 mt-1 select-none">
 ...
 : 'bg-zinc-100 dark:bg-zinc-950 border border-zinc-200/50 dark:border-zinc-800 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white'
 }`}
 >
 ...
 className="p-2 rounded-xl bg-zinc-50 dark:bg-zinc-950 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-all cursor-pointer"
 ...
 <li>Type <strong className="font-bold text-zinc-900 dark:text-white">@username</strong> to mention other members and issue alerts.</li>
 <li>Select <strong className="font-bold text-zinc-900 dark:text-white">Private Diary</strong> to isolate logs strictly to your own eyes.</li>
 </ul>
 </div>
 </div>
 <p className="mt-3 pt-2 text-[10px] text-zinc-400 dark:text-zinc-500 select-none font-mono">
 ...
 : 'border-zinc-200 hover:border-zinc-400 dark:border-zinc-800 dark:hover:border-zinc-700 bg-white/20 dark:bg-zinc-900/20'
 }`}
 >
 <div className="flex items-center gap-1.5">
 ...
 <span className="text-xs font-bold text-zinc-800 dark:text-zinc-100 mt-1">
 ...
 <div className="flex flex-wrap items-center justify-center gap-2 mt-4 pt-3 w-full">
 <button
 type="button"
 onClick={() => {
 const d = new Date();
