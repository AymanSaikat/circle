...
export const CirclesSkeleton: React.FC = () => {
  return (
    <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 shadow-xs animate-pulse select-none">
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="w-14 h-6 bg-zinc-100 dark:bg-zinc-800 rounded-lg" />
      </div>
      ...
      <div className="flex items-center gap-6 mt-6 pt-3 border-t border-zinc-150 dark:border-zinc-800/60">
        <div className="flex items-center gap-2">
          ...
          <div className="h-3 w-6 bg-zinc-100 dark:bg-zinc-850 rounded" />
        </div>
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 bg-zinc-200 dark:bg-zinc-800 rounded-full" />
          <div className="h-3 w-6 bg-zinc-100 dark:bg-zinc-850 rounded" />
