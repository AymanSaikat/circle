...
export const Navbar: React.FC<NavbarProps> = ({ 
 ...
 <aside className="hidden md:flex w-20 xl:w-64 flex-col bg-white dark:bg-zinc-950 text-zinc-900 dark:text-zinc-50 h-[100dvh] min-h-[100dvh] p-3 xl:p-6 sticky top-0 shrink-0 justify-between select-none z-30 transition-all duration-300 shadow-[10px_0_40px_rgba(0,0,0,0.03)] dark:shadow-none">
 ...
 <header className="flex md:hidden items-center justify-between bg-white dark:bg-zinc-950 px-4 py-3 sticky top-0 z-40 select-none shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-none">
 ...
 <div className="md:hidden fixed bottom-0 inset-x-0 bg-white/95 dark:bg-zinc-950/95 backdrop-blur-md px-2 py-1.5 flex items-center justify-around z-30 select-none pb-safe-bottom shadow-[0_-10px_40px_rgba(0,0,0,0.05)] dark:shadow-none">
 
 <button
 id="mobile-tab-home"
 onClick={() => handleTabClick('feed')}
 className={`flex flex-col items-center justify-center p-2 rounded-xl transition-all ${
 currentTab === 'feed' && !selectedTag ? 'text-zinc-950 dark:text-white font-extrabold scale-110' : 'text-zinc-400 hover:text-zinc-600'
 }`}
 ...
 onClick={() => handleTabClick('search')}
 className={`flex flex-col items-center justify-center p-2 rounded-xl transition-all ${
 currentTab === 'search' ? 'text-zinc-950 dark:text-white font-extrabold scale-110' : 'text-zinc-400 hover:text-zinc-600'
 }`}
 style={{ minHeight: '44px', minWidth: '44px' }}
 >
 ...
 currentTab === 'messages' ? 'text-zinc-950 dark:text-white font-extrabold scale-110' : 'text-zinc-400 hover:text-zinc-600'
 }`}
 style={{ minHeight: '44px', minWidth: '44px' }}
 title="Messages"
 aria-label="Messages"
 ...
 onClick={() => handleTabClick('private')}
 className={`flex flex-col items-center justify-center p-2 rounded-xl transition-all ${
 currentTab === 'private' ? 'text-zinc-950 dark:text-white font-extrabold scale-110' : 'text-zinc-400 hover:text-zinc-600'
 }`}
 style={{ minHeight: '44px', minWidth: '44px' }}
 >
 ...
 onClick={() => handleTabClick('bookmarks')}
 className={`flex flex-col items-center justify-center p-2 rounded-xl transition-all ${
 currentTab === 'bookmarks' ? 'text-zinc-950 dark:text-white font-extrabold scale-110' : 'text-zinc-400 hover:text-zinc-600'
 }`}
 style={{ minHeight: '44px', minWidth: '44px' }}
 >
 ...
 onClick={() => handleTabClick('profile')}
 className={`flex flex-col items-center justify-center p-2 rounded-xl transition-all ${
 currentTab === 'profile' ? 'text-zinc-950 dark:text-white font-extrabold scale-110' : 'text-zinc-400 hover:text-zinc-600'
 }`}
 style={{ minHeight: '44px', minWidth: '44px' }}
 >
 {profile ? (
