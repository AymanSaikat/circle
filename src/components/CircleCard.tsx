...
export const CircleCard: React.FC<CircleCardProps> = ({ memo, onTagClick, onDeleteSuccess }) => {
 ...
 className="text-zinc-900 dark:text-zinc-100 hover:text-zinc-700 dark:hover:text-zinc-400 font-bold underline cursor-pointer inline-block"
 >
 {displayUrl}
 </a>
 );
 ...
 <div className="flex items-center gap-1.5 text-zinc-400 dark:text-zinc-500 font-mono text-[9px] font-bold uppercase tracking-wider select-none">
 ...
 <div className="flex items-center justify-between text-[10px] text-zinc-400 dark:text-zinc-500 font-mono mt-1">
 ...
 <div className="flex items-center gap-2 text-[10px] text-zinc-500 dark:text-zinc-400 font-bold font-mono mt-0.5">
 ...
 following
 ? 'bg-zinc-100 dark:bg-zinc-800 text-zinc-600 dark:text-zinc-300 border border-zinc-200 dark:border-zinc-700 hover:text-red-600 hover:bg-zinc-200 dark:hover:bg-zinc-700'
 : 'bg-zinc-900 dark:bg-zinc-100 text-white dark:text-zinc-950 hover:bg-zinc-800 dark:hover:bg-zinc-200 shadow-sm'
 }`}
 >
 ...
 className="p-2 rounded-xl text-zinc-400 dark:text-zinc-500 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all border border-transparent hover:border-red-100 dark:hover:border-red-900/40 cursor-pointer"
 title="Delete Circle"
 >
 ...
 className="w-full text-left px-4 py-3 sm:py-2 hover:bg-zinc-50 dark:hover:bg-zinc-900 text-zinc-700 dark:text-zinc-400 flex items-center gap-3 sm:gap-2.5 cursor-pointer font-bold active:bg-zinc-100 dark:active:bg-zinc-800 transition-colors"
 >
 ...
 <div className="my-1 sm:my-1 w-full mx-auto" />
 ...
 liked ? 'text-red-600 dark:text-red-550' : 'text-zinc-500 dark:text-zinc-455 hover:text-red-600'
 }`}
 >
 ...
 : 'text-zinc-500 dark:text-zinc-455 hover:text-[#1877f2] hover:bg-zinc-100 dark:hover:bg-zinc-800'
 }`}
 ...
 {showComments && (
 <div id={`comments-panel-${memo.id}`} className="mt-4 pt-4 bg-zinc-50 dark:bg-zinc-950 rounded-2xl p-4">
 <h3 className="text-[10px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest mb-3 select-none">
 Comments
 </h3>
 ...
 {comments.length === 0 ? (
 <p className="text-xs text-zinc-400 dark:text-zinc-500 py-1 italic select-none">
 No comments yet. Write the first response!
 </p>
 ) : (
 comments.map(c => (
 <div key={c.id} className="flex gap-2.5 items-start text-xs pb-2.5 last:border-b-0 group">
 <img
 src={c.avatarUrl}
 alt={c.displayName}
 ...
 <p className="text-xs text-zinc-400 dark:text-zinc-500 font-mono">@{memo.username}</p>
 </div>
 ...
 {/* Immersive Text */}
 <div className={`text-zinc-800 dark:text-zinc-100 leading-relaxed font-sans tracking-wide break-words select-text mb-8 ${
 ...
 <div className="flex flex-wrap items-center justify-between gap-4 pt-6 text-[11px] font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-widest font-mono">
 <span className="flex items-center gap-1">
