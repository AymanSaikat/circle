...
export const LinkPreview: React.FC<{ url: string }> = ({ url }) => {
  ...
  return (
    <a
      ...
      className="block mt-3 border border-zinc-200 dark:border-zinc-800 rounded-xl overflow-hidden bg-zinc-50/50 dark:bg-zinc-900/30 hover:bg-zinc-100/50 dark:hover:bg-zinc-850/30 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-250 select-none group"
    >
      <div className="flex flex-col sm:flex-row">
        {data.image && (
          <div className="sm:w-36 md:w-44 h-28 sm:h-auto shrink-0 relative bg-zinc-100 dark:bg-zinc-850 overflow-hidden border-b sm:border-b-0 sm:border-r border-zinc-200 dark:border-zinc-800">
            <img
              src={data.image}
              alt={data.title}
