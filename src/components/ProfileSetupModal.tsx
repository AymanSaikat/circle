  ...
  return (
    <div className="fixed inset-0 bg-zinc-950/60 dark:bg-zinc-950/80 backdrop-blur-md flex items-center justify-center p-3 md:p-6 z-50 animate-fade-in">
      ...
      <div className="w-full max-w-4xl h-[90vh] md:h-[82vh] bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-900 rounded-3xl shadow-2xl relative flex flex-col md:flex-row overflow-hidden select-none">
        ...
        <div className="w-full md:w-72 border-b md:border-b-0 md:border-r border-zinc-150 dark:border-zinc-900 bg-zinc-50/50 dark:bg-zinc-900/10 flex flex-col scrollbar-none justify-between shrink-0">
          
          <div className="p-5 border-b border-zinc-150 dark:border-zinc-905 flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <div className="p-1.5 bg-zinc-100 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 rounded-lg">
                <Shield className="w-4 h-4 text-zinc-650 dark:text-zinc-350" />
              </div>
              <div>
            ...
            {!forceOnboarding && (
              <button 
                onClick={onClose} 
                className="p-1 rounded-lg text-zinc-450 hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-colors"
                title="Exit Settings"
              >
                <X className="w-4 h-4" />
              </button>
                ...
                <button
                  ...
                  className={`flex items-center gap-3 w-max md:w-full px-4 py-2.5 md:py-3 rounded-2xl relative text-xs font-bold transition-all text-left group shrink-0 select-none ${
                    ...
                    isActive
                      ...
                      : 'text-zinc-505 dark:text-zinc-400 hover:bg-zinc-100/60 dark:hover:bg-zinc-900/50 hover:text-zinc-900 dark:hover:text-zinc-200'
                  }`}
                >
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-zinc-950 overflow-hidden relative">
          ...
          {forceOnboarding && (
            <div className="bg-gradient-to-r from-zinc-900 to-zinc-800 dark:from-zinc-100 dark:to-zinc-200 px-6 py-3.5 text-white dark:text-zinc-950 font-sans flex items-center justify-between border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6">
            ...
            {activeTab === 'profile' && (
              <form onSubmit={handleSaveProfile} className="space-y-6">
                ...
                <div className="group flex flex-col items-center gap-3 bg-zinc-50/50 dark:bg-zinc-900/30 p-5 border border-zinc-150 dark:border-zinc-900 rounded-2xl">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3.5 py-1.5 border border-zinc-250 dark:border-zinc-800 hover:bg-zinc-50/20 dark:hover:bg-zinc-900 text-zinc-700 dark:text-zinc-300 rounded-xl text-[10px] font-bold cursor-pointer transition-all select-none"
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-100 placeholder-zinc-405 dark:placeholder-zinc-650 rounded-2xl pl-8 pr-12 py-3 text-xs focus:outline-none transition-all border ${
                ...
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-zinc-50 dark:bg-zinc-900 text-zinc-900 dark:text-zinc-150 rounded-2xl px-3.5 py-3 text-xs focus:outline-none border border-zinc-200 dark:border-zinc-800 focus:border-zinc-950 dark:focus:border-zinc-100 transition-all font-medium"
                  />
                </div>
                ...
                {error && (
                  <div className="bg-red-50 dark:bg-red-950/20 border border-red-200 dark:border-red-900/30 p-3.5 rounded-2xl text-[10px] text-red-650 dark:text-red-405 font-mono flex items-center gap-1.5 leading-snug">
              ...
              <form onSubmit={saveOtherSettings} className="space-y-6">
                ...
                <div className="pt-6 border-t border-zinc-100 dark:border-zinc-900 space-y-4">
                  ...
                  <div className="p-4 bg-red-50/40 dark:bg-red-950/10 border border-red-100 dark:border-red-950/40 rounded-2xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                    <div>
                      <h4 className="text-xs font-bold text-red-655 dark:text-red-400">Deactivate Account</h4>
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 border border-red-200 dark:border-red-900 hover:bg-red-50 dark:hover:bg-red-950/30 text-red-650 dark:text-red-400 font-bold text-[10px] rounded-xl cursor-pointer transition-colors shrink-0"
                    >
          ...
          <div className="p-4 border-t border-zinc-105 dark:border-zinc-900 flex justify-end gap-3 select-none shrink-0 bg-white dark:bg-zinc-950">
            {!forceOnboarding && (
              <button
                ...
                onClick={onClose}
                className="px-5 py-2.5 rounded-2xl text-xs font-bold bg-zinc-100 hover:bg-zinc-200 dark:bg-zinc-900 dark:hover:bg-zinc-850 text-zinc-700 dark:text-zinc-300 transition-all cursor-pointer"
              >
                Close Settings
              </button>
            )}
